...
public class WebdiverAPITest01 {
	...
	public void testWebdriverAPIs() throws InterruptedException{
		 ...
		 * open aut url
		 */		
		driver.get("http://localhost:8080/centos/selapi.html");
		...
		//verify current url 
		Assert.assertEquals(current_URL, "http://localhost:8080/centos/selapi.html");
		...
		driver.get("http://localhost:8080/centos/drag.html");
		...
		Assert.assertEquals(driver.getCurrentUrl(), "http://localhost:8080/centos/selapi.html");
		driver.navigate().forward();
		Assert.assertEquals(driver.getCurrentUrl(), "http://localhost:8080/centos/drag.html");
